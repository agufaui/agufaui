...
<script lang="ts">
export default {
	name: "Asub", // name field must be specified for plugin (global component registration) to work
	inheritAttrs: false,
};
</script>
...
const props = withDefaults(defineProps<IASubProps>(), {
	// #region props
	spacex: "space-x-1.5",
	// #endregion props
});
...
const computedProperties = getComputedFromProps<IASubProps>(props, CASubName, config);
